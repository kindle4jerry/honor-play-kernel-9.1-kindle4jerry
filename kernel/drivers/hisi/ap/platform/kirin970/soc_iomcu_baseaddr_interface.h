...
#define SOC_IOMCU_DMSS_TZMP2_BASE_ADDR (0x5FFB0000)
...
#define SOC_IOMCU_BISR_BASE_ADDR (0x5F012000)
...
#define SOC_IOMCU_PI_MON_BASE_ADDR (0x5DF14000)
...
#define SOC_IOMCU_MEDIA1_CRG_BASE_ADDR (0x487A0000)
#define SOC_IOMCU_MEDIA_COMMON_BASE_ADDR (0x48700000)
#define SOC_IOMCU_NOC_VIVO_Service_Target_BASE_ADDR (0x486F0000)
#define SOC_IOMCU_NOC_IVP32_Service_Target_BASE_ADDR (0x486E0000)
...
#define SOC_IOMCU_ISP_SMMU_BASE_ADDR (0x48560000)
...
#define SOC_IOMCU_CDSP_IMEM_BASE_ADDR (0x43940000)
#define SOC_IOMCU_CDSP_DMEM_BASE_ADDR (0x43840000)
#define SOC_IOMCU_DSP0_L2MEM_BASE_ADDR (0x436C0000)
...
#define SOC_IOMCU_WDT_CDSP_BASE_ADDR (0x40211000)
