...
#ifdef ADD_OTHER_CHANGE
	{"raw NTLMv2 auth", P_BOOL, P_GLOBAL, &Globals.bRawNTLMv2Auth, NULL, NULL, FLAG_ADVANCED,},
#endif
...
#ifdef ADD_LOG_SIZE_CONTROL
	{"max log files", P_INTEGER, P_GLOBAL, &Globals.max_log_files, NULL, NULL, FLAG_ADVANCED},
#endif
...
#ifdef ADD_LOG_SIZE_CONTROL
FN_GLOBAL_INTEGER(lp_max_log_files, &Globals.max_log_files)
#endif
