...
extern struct mntent *getmntent_r(FILE *filep, struct mntent *mnt, char *buff, int bufsize);

extern struct mntent *getmntent(FILE * filep);

extern int addmntent(FILE * filep, const struct mntent *mnt);

extern char *hasmntopt(const struct mntent *mnt, const char *opt);

extern FILE *setmntent(const char *name, const char *mode);
